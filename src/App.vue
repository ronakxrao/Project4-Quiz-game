<template>
  ...
  <div>
    ...
    <template v-if="this.question">
      ...
      <button v-if="!this.answerSumbitted" @click="this.sumbitAnswer()" class="send" type="button">Send</button>

      <section v-if="this.answerSumbitted" class="result">
